...
export default function AboutUs() {
    return (
        <>
            ...
            <section className='flex flex-col md:flex-row items-center py-5 px-5 md:px-10'>
                <div className='flex-1 flex justify-center item-center mb-5 md:mb-0'>
                    <Image src='/images/direktur1.webp' alt="Foto Direktur Utama" width={500} height={500} className='w-3/4 md:w-1/2 h-auto' loading="lazy" />
                </div>
                <div className='flex-1 flex-col'>
                    <div>
                        <h1 className='text-2xl md:text-3xl' tabIndex="0">
                            SAMBUTAN DIREKTUR UTAMA
                        </h1>
                    </div>
                    <div className='text-justify text-base md:text-lg' tabIndex="0">
                        <p>
            ...
            <section className='flex flex-col md:flex-row justify-between py-5 px-5 md:px-10 gap-10'>
                <div className='bg-black bg-opacity-5 flex-1 p-5 md:p-10 rounded-lg shadow-md' tabIndex="0" aria-labelledby="perencanaan">
                    <FaBookBookmark className='h-10 w-10 text-black mx-auto' />
                    <h2 id="perencanaan" className='font-bold text-xl md:text-2xl text-center text-black mt-2'>
                        Perencanaan
                    </h2>
                ...
                <div className='flex-1 bg-black bg-opacity-5 p-5 md:p-10 rounded-lg shadow-md' tabIndex="0" aria-labelledby="pengerjaan">
                    <RxLapTimer className='h-10 w-10 mx-auto' />
                    <h2 id="pengerjaan" className='font-bold text-xl md:text-2xl text-center mt-2'>
                        Pengerjaan
                    </h2>
                    <p className='text-justify mt-2'>
                ...
                <div className='flex-1 bg-black bg-opacity-5 p-5 md:p-10 rounded-lg shadow-md' tabIndex="0" aria-labelledby="pelayanan">
                    <RiCustomerService2Line className='h-10 w-10 mx-auto' />
                    <h2 id="pelayanan" className='font-bold text-xl md:text-2xl text-center mt-2'>
                        Pelayanan
                    </h2>
                    <p className='text-justify mt-2'>
            ...
            <section className='bg-black bg-opacity-5 py-5 px-5 md:px-10 rounded-lg shadow-md' tabIndex="0">
                <section className='flex justify-center py-5 px-5 md:px-20'>
                    <div>
            ...
            <section className='py-5 px-5 md:px-10 rounded-lg shadow-md'>
                ...
                <section className='flex flex-col md:flex-row justify-between py-5 px-5 md:px-10 gap-5'>
                    <div className='bg-black bg-opacity-5 p-5 md:p-10 flex-1 flex flex-col items-center rounded-lg shadow-md' tabIndex="0" aria-labelledby="portofolio1">
                    ...
                    <div className='bg-black bg-opacity-5 p-5 md:p-10 flex-1 flex flex-col items-center rounded-lg shadow-md' tabIndex="0" aria-labelledby="portofolio2">
                    ...
                    <div className='bg-black bg-opacity-5 p-5 md:p-10 flex-1 flex flex-col items-center rounded-lg shadow-md' tabIndex="0" aria-labelledby="portofolio3">
                ...
                <section className='flex flex-col md:flex-row justify-between py-5 px-5 md:px-10 gap-5'>
                    <div className='bg-black bg-opacity-5 p-5 md:p-10 flex-1 flex flex-col items-center rounded-lg shadow-md' tabIndex="0" aria-labelledby="portofolio4">
                    ...
                    <div className='bg-black bg-opacity-5 p-5 md:p-10 flex-1 flex flex-col items-center rounded-lg shadow-md' tabIndex="0" aria-labelledby="portofolio5">
                    ...
                    <div className='bg-black bg-opacity-5 p-5 md:p-10 flex-1 flex flex-col items-center rounded-lg shadow-md' tabIndex="0" aria-labelledby="portofolio6">
            ...
            <section className='flex flex-center justify-center py-10 px-5 md:px-10 items-center'>
                <h2 className='text-xl md:text-2xl font-bold'>
                    OUR CLIENTS
                </h2>
            </section>
            <section id='our clients' className='flex flex-center justify-center px-5 md:px-10 items-center'>
                <section id='logo' className='grid grid-cols-2 md:grid-cols-4 gap-5 justify-center items-center'>
                    <div className='flex justify-center items-center'>
                        <Image src="/images/logobankiindex.webp" alt="Client Logo Bank Index" width={150} height={30} loading="lazy" />
                    </div>
                    <div className='flex justify-center items-center cursor-pointer'>
                        <Image src="/images/logobankpanin.webp" alt="Client Logo Bank Panin" width={150} height={30} loading="lazy" />
                    </div>
                    <div className='flex justify-center items-center cursor-pointer'>
                        <Image src="/images/logobri.webp" alt="Client Logo BRI" width={150} height={30} loading="lazy" />
                    </div>
                    <div className='flex justify-center items-center cursor-pointer'>
                        <Image src="/images/logojco.webp" alt="Client Logo JCo" width={150} height={30} loading="lazy" />
                    </div>
                    <div className='flex justify-center items-center cursor-pointer'>
                        <Image src="/images/logoprotoindo.webp" alt="Client Logo Protonindo" width={150} height={30} loading="lazy" />
                    </div>
                    <div className='flex justify-center items-center cursor-pointer'>
                        <Image src="/images/logorge.webp" alt="Client Logo RGE" width={150} height={30} loading="lazy" />
                    </div>
                    <div className='flex justify-center items-center cursor-pointer'>
                        <Image src="/images/logoskyland.webp" alt="Client Logo Skyland" width={150} height={30} loading="lazy" />
                    </div>
                    <div className='flex justify-center items-center cursor-pointer'>
                        <Image src="/images/logosriwijayaair.webp" alt="Client Logo Sriwijaya Air" width={150} height={30} loading="lazy" />
                    </div>
                    <div className='flex justify-center items-center cursor-pointer'>
                        <Image src="/images/logoudistira.webp" alt="Client Logo RS Dustira" width={150} height={30} loading="lazy" />
                    </div>
                    <div className='flex justify-center items-center cursor-pointer'>
                        <Image src="/images/logotelkomakses.webp" alt="Client Logo Telkom Akses" width={150} height={30} loading="lazy" />
                    </div>
                </section>
            </section>
        </>
